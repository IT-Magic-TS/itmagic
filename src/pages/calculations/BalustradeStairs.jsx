      ...
      <div className='flex justify-center'>
        <div className='w-2/3'>
          <picture>
            ...
            <img src={imgPng} alt="Stair Balustrade" className='max-w-lg block mx-auto border border-stone-300 p-2 rounded-sm' />
          </picture>
          <picture>
            <source srcSet={abcSmallWeb} type='image/webp' />
            <source srcSet={abcSmallPng} type='image/png' />
            <img src={abcSmallPng} alt="Stair Balusters" className='max-w-lg block mx-auto border border-stone-300 p-2 rounded-sm mt-3' />
          </picture>
        </div>
        <div className='w-1/3'>
...
export default BalustradeStairs